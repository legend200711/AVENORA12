...
const CACHE_NAME  = 'avenora-cache-v52';
...
const OLD_CACHE_PREFIXES = [
  ...
  'avenora-cache-v38', // v38 — evict: broken track reference repair (Cloud Radio)
  ...
  'avenora-cache-v44', // v44 — evict: playlist count Firestore realtime, volume fix, radio continuous loop
  'avenora-cache-v45', // v45 — evict: radio engine as sole authority, listener read-only, drift correction 3s, real audio duration
  'avenora-cache-v46', // v46 — evict: intermediate
  'avenora-cache-v47', // v47 — evict: radio engine master clock, visualizer fix, recovery loop fix
  'avenora-cache-v48', // v48 — evict: radio audio seek race-condition, playlist Firestore membership, Radio↔MusicHub conflict
  'avenora-cache-v49', // v49 — evict: media ecosystem repair (playlist counts, player coordination, picture/audio CSR)
  'avenora-cache-v50', // v50 — evict: profile avatar broken-image fix
  'avenora-cache-v51', // v51 — evict: full system repair & stabilization
  // v52 = current — not in evict list
